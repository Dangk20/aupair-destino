...
//
// Se guardan en UPLOADS_DIR (por defecto <cwd>/almacenamiento), montado como
// volumen en producción, y se sirven por /api/documentos/[id], que exige sesión.
// Directorio propio a propósito: `data/` ya existe en el repo y contiene módulos
// que el sitio público importa.
//
...
export function raizAlmacenamiento() {
  return process.env.UPLOADS_DIR || path.join(process.cwd(), "almacenamiento");
}
