    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#fff8f9]">
      ...
      <div className="lg:w-[45%] bg-[#a0435f] relative overflow-hidden flex flex-col items-center justify-center p-8 lg:p-12 py-10 lg:py-12">
        ...
        <div className="relative z-10 text-center w-full max-w-xs mx-auto">
          ...
          {/* Progreso — oculto en mobile para no hacer muy largo el panel */}
          <div className="hidden sm:block bg-white/10 border border-white/15 rounded-2xl p-4 text-left">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-[12px] font-semibold text-[#2d1a22] tracking-wide uppercase">
                  Contraseña
                </label>
            ...
            <p className="text-center text-[13px] text-[#9a6672] pt-1">
              ¿No tienes cuenta?{" "}
              <Link href="/register" className="text-[#a0435f] font-medium hover:underline">
                Regístrate gratis
              </Link>
            </p>
