    ...
    <div className="min-h-screen bg-[#fff8f9] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[15px] text-[#7a4a54] leading-relaxed max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
          ...
          <div className="bg-white border border-[#f0dde2] rounded-3xl overflow-hidden shadow-sm flex flex-col">
            <div className="h-1 bg-gradient-to-r from-[#2d1a22] via-[#e8849a] to-[#2d1a22]" />
            ...
            <div className="relative h-64 overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4">
                <span className="inline-block bg-white/90 backdrop-blur-sm text-[#a0435f] text-[10px] font-bold px-3 py-1.5 rounded-full tracking-widest uppercase border border-[#f0b8c4]">
                  ✨ Las creadoras
                </span>
              </div>
            </div>
            ...
            <div className="p-5 flex-1 flex flex-col">
              ...
              <div className="flex flex-wrap gap-2">
                {["Au pairs certificadas", "500+ chicas", "Colombia 🇨🇴"].map((tag, i) => (
                  <span key={i} className="text-[11px] bg-[#fff0f3] text-[#9a6672] px-2.5 py-1 rounded-full border border-[#f0dde2]">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* Card WhatsApp */}
            <div className="bg-white border border-[#f0dde2] rounded-3xl p-6 text-center shadow-sm flex-1 flex flex-col items-center justify-center">
              ...
              <p className="text-[13px] text-[#9a6672] mb-6 leading-relaxed max-w-xs mx-auto">
            ...
            <div className="bg-white border border-[#f0dde2] rounded-2xl p-5 shadow-sm">
              <h3 className="font-semibold text-[13px] text-[#2d1a22] mb-3">¿Qué vas a encontrar?</h3>
              <ul className="space-y-2">
                {[
                  { emoji: "🤝", text: "Apoyo de chicas en el mismo proceso" },
                  { emoji: "💡", text: "Consejos de au pairs que ya viajaron" },
                  { emoji: "📋", text: "Ayuda con documentos y entrevistas" },
                  { emoji: "🎉", text: "Celebraciones de cada logro" },
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-2.5">
                    <span className="text-[15px] shrink-0">{item.emoji}</span>
                    <p className="text-[12px] text-[#7a4a54] leading-relaxed">{item.text}</p>
                  </li>
                ))}
              </ul>
            </div>
