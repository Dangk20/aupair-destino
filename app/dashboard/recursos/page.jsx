...
import {
  ...
  Link2, BookOpen, CheckSquare, Mic, Lock,
} from "lucide-react";
      ...
      <div style={{ maxWidth:1400, margin:"0 auto", padding:"20px 24px 40px", display:"flex", gap:20 }}>
            ...
            {filtrados.length===0 ? (
              ...
              return (
                <div key={r.id} className="rec-row"
                  ...
                  <div style={{ width:46, height:46, borderRadius:14, flexShrink:0, display:"flex", alignItems:"center", justifyContent:"center", fontSize:22, background:tipoCfg.bg }}>
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    ...
                    {r.descripcion && <p style={{ fontSize:12, color:"#9a7080", margin:0, lineHeight:1.4 }}>{r.descripcion}</p>}
                    <div style={{ display:"flex", gap:8, marginTop:5 }}>
                      <span style={{ fontSize:10, fontWeight:600, background:tipoCfg.bg, color:tipoCfg.color, padding:"2px 8px", borderRadius:99, textTransform:"uppercase" }}>{r.tipo}</span>
        ...
        <aside style={{ width:260, flexShrink:0, display:"flex", flexDirection:"column", gap:14 }}>
          <div style={{ background:"#fff", borderRadius:20, border:"1px solid #ece4f0", padding:20, textAlign:"center" }}>
            ...
            <p style={{ fontFamily:"Georgia,serif", fontSize:16, fontWeight:700, color:"#1e1033", margin:"0 0 2px" }}>{fasesCompletadas} de 5 fases</p>
