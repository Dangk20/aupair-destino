...
import { CheckCircleIcon, DownloadIcon, CalendarIcon, StarIcon } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fff8f9]">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-flex items-center gap-2 bg-[#fce8ed] border border-[#f0b8c4] text-[#a0435f] text-[12px] font-semibold px-4 py-1.5 rounded-full mb-5">
            <CheckCircleIcon size={13} />
            Programa completado
          </div>
          <h1 className="font-serif text-[36px] md:text-[42px] font-bold text-[#2d1a22] leading-tight mb-4">
            ¡Lo lograste,{" "}
        ...
        <div className="flex justify-center gap-1 mb-10">
          {[...Array(5)].map((_, i) => (
            <StarIcon key={i} size={24} fill="#e8849a" className="text-[#e8849a]" />
          ))}
        </div>
        ...
        <div className="space-y-4 mb-8">
          ...
          <a href="https://chat.whatsapp.com/TU-LINK-AQUI" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-4 bg-white border border-[#f0dde2] rounded-2xl p-5 hover:border-[#25D366] hover:shadow-md transition group">
            ...
            <div className="flex-1">
              <p className="text-[15px] font-semibold text-[#2d1a22] group-hover:text-[#25D366] transition">Unirme a la comunidad privada</p>
              <p className="text-[12px] text-[#9a6672] mt-0.5">Grupo de WhatsApp exclusivo para au pairs en proceso</p>
            </div>
          ...
          <a href="https://calendly.com/TU-LINK-AQUI" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-4 bg-white border border-[#f0dde2] rounded-2xl p-5 hover:border-[#e8849a] hover:shadow-md transition group">
            <div className="w-12 h-12 rounded-2xl bg-[#a0435f] flex items-center justify-center shrink-0">
              <CalendarIcon size={20} className="text-white" />
            </div>
            <div className="flex-1">
              <p className="text-[15px] font-semibold text-[#2d1a22] group-hover:text-[#a0435f] transition">Agendar revisión con Jennifer y Tati</p>
              <p className="text-[12px] text-[#9a6672] mt-0.5">Revisión personalizada de tu perfil y próximos pasos</p>
            </div>
          ...
          <a href="/dashboard/certificado"
            className="flex items-center gap-4 bg-[#a0435f] rounded-2xl p-5 hover:bg-[#8a3550] transition group">
        ...
        <div className="bg-white border border-[#f0dde2] rounded-2xl p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="flex -space-x-2">
              <div className="w-9 h-9 rounded-full bg-[#fce8ed] border-2 border-white flex items-center justify-center">
            ...
            <div>
              <p className="text-[13px] font-semibold text-[#2d1a22]">Jennifer y Tati</p>
              <p className="text-[11px] text-[#9a6672]">Creadoras de Destino Au Pair</p>
            </div>
          </div>
          <p className="text-[14px] text-[#7a4a54] leading-relaxed italic">
