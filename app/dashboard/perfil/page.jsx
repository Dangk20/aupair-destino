...
//
// Ahora esta pantalla cubre los dos momentos y no hay una segunda a la que ir:
//   · perfil a medias  → el recorrido de las secciones y qué falta en cada una
//   · perfil completo  → pestañas con sus datos, de sólo lectura
//
// Se probó con la vista consolidada en su propia ruta (/perfil/vista) y sobraba:
// el índice y esa vista mostraban lo mismo con dos diseños distintos.
//
...
import {
  Pencil, MapPin, Mail, Cake, CheckCircle2, Clock,
...
export default function PerfilPage() {
  ...
  return (
    <div style={{ fontFamily: T.font, color: T.text, padding: isMobile ? "16px 16px 90px" : "28px 30px", maxWidth: 860, margin: "0 auto", width: "100%", display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      <div>
        <div style={{ fontSize: isMobile ? 21 : 26, fontWeight: 700, color: T.text, lineHeight: 1.1 }}>Mi perfil</div>
        <div style={{ fontSize: 13.5, color: T.textSoft, marginTop: 3 }}>
          {completo
      ...
      {/* Qué sigue — lo explicaba el índice que esta pantalla reemplaza */}
      {completo && (
