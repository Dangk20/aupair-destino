  ...
  function SidebarContent() {
    return (
      <div style={{ width: 200, minWidth: 200 }}
        ...
        {/* Fondo imagen NYC con overlay */}
        <div className="absolute inset-0 pointer-events-none">
          <img
            src="https://images.unsplash.com/photo-1534430480872-3498386e7856?w=800&q=60"
            alt=""
        ...
        <div className="relative z-10 px-5 pt-6 pb-4 border-b border-white/10">
          ...
          <p className="text-[9px] font-bold tracking-[3px] uppercase text-[#e8849a]">
            Panel Admin
          </p>
        </div>
        ...
        <div className="relative z-10 flex justify-center pb-4">
          <div className="w-20 h-28 relative shadow-xl opacity-60"
            ...
            <div className="absolute left-3 top-0 right-0 h-full bg-[#a0435f] rounded-r-xl
                            flex flex-col items-center justify-between py-2 px-2">
              <div className="w-full h-px bg-white/20"/>
              <div className="flex flex-col items-center gap-1">
                <img src="/assets/destino-aupair-logo.svg" alt=""
                     className="w-8 h-8 brightness-0 invert opacity-90"/>
                <p className="text-white text-[5px] tracking-[2px] uppercase font-bold opacity-80">
                  Au Pair
                </p>
              </div>
              <div className="w-full h-px bg-white/20"/>
  ...
  return (
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "#fff8f9" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <header className="md:hidden bg-[#fff8f9] border-b border-[#f0dde2] px-4 py-3
