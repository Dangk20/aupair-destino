...
- [x] 2.1 Inventariar en el VPS qué archivos existen bajo el volumen `uploads` y dejar constancia del resultado en las notas técnicas privadas
...
- [x] 4.7 Desplegar siguiendo el plan de migración y verificar en producción los recorridos 4.1 y 4.3
